...
class ReaderPrinter(object):
    ...
    def writeHeader(self, v=""):
        ...
        self.write(
            ...
            % {
                "fullbook": fullName(self.previousChapter()[0]),
                "book": readerName(self.previousChapter()[0]),
        ...
        self.write(
            ...
            % {
                "fullbook": fullName(self.nextChapter()[0]),
                "book": readerName(self.nextChapter()[0]),
        ...
        self.write(
            ...
            % {"book": readerName(self.cb), "chapter": str(int(self.cc))}
        )
    ...
    def renderREM(self, token):
        pass  # This is for comments in the USFM
